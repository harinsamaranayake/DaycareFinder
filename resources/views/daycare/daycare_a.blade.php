...
@section('content')
    <div class="m-4">
        ...
        <div class="p-4 my-4" style="background-color:">
            <div class="row">
                <div class="col-sm">
        ...
        <div class="m-4" id="search_update_daycare_div" style="display:none">
            {{-- {!! Form::open(['action' => 'DaycareController@mymethod','method' => 'POST']) !!} --}}
            {!! Form::open(['action' => 'DaycareController@update_x','method' => 'POST']) !!}
                <div class="row">
                    <div class="col-sm">
                        <div class="col-sm">
                    ...
                    <div class="col-sm">
                        <div style="text-align: center;" >
                            ...
                            {{-- <button class="btn btn-outline-success" type="submit" onclick="update_daycare()" id="search_update_daycare_btn" style="display: none">Update</button> --}}
                            {{-- <button class="btn btn-outline-danger" type="submit" onclick="delete_daycare()" id="search_delete_daycare_btn" style="display: none">Delete</button> --}}
                            {{Form::submit('Update',['class'=>'btn btn-outline-success'])}}
                            {{-- <button class="btn btn-outline-success" type="submit" onclick="update_daycare()" id="search_update_daycare_btn" style="display: none">Update</button> --}}
                            {{-- <button class="btn btn-outline-danger" type="submit" onclick="delete_daycare()" id="search_delete_daycare_btn" style="display: none">Delete</button> --}}
                        </div>
        ...
        <div class="m-4" id="search_delete_daycare_div" style="display:none">
            {{-- {!! Form::open(['action' => ['DaycareController@destroy', ],'method' => 'POST']) !!} --}}
            {!! Form::open(['action' => 'DaycareController@delete_x','method' => 'POST']) !!}
                <div class="row">
                    <div class="col-sm">
                        <div class="col-sm">
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-3 col-form-label">Enter Daycare ID</label>
                                <div class="col-sm-9">
                                    {{Form::text('delete_daycare_id','',['class'=>'form-control'])}}
                                </div>
                            </div>
                        </div> 
                    </div>
                ...
                <div class="row">
                    <div class="col-sm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{-- {{Form::date('started_on',\Carbon\Carbon::now())}} --}}
                                {{ Form::date('started_on', \Carbon\Carbon::now(), ['class' => 'form-control', 'id'=>'datetimepicker']) }}
                                {{-- <input type="text" class="form-control" id="owner"> --}}
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('ad01','',['class'=>'form-control'])}}
                                {{-- <input type="text" class="form-control" id="daycarename" > --}}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('ad02','',['class'=>'form-control'])}}
                                {{-- <input type="text" class="form-control" id="owner"> --}}
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="col-sm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('web','',['class'=>'form-control ','placeholder'=>'www.website.com'])}}
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('price','',['class'=>'form-control ','placeholder'=>'Eg: 1000'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                {{Form::text('age_low','',['class'=>'form-control ','placeholder'=>'Lower Age'])}}
                                {{-- <input type="text" class="form-control" id="owner" placeholder="Latitude"> --}}
                            </div>
                            <div class="col-sm-4">
                                {{Form::text('age_high','',['class'=>'form-control ','placeholder'=>'Higher Age'])}}
                                {{-- <input type="text" class="form-control" id="owner" placeholder="Longitude"> --}}
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('students_per_teacher','',['class'=>'form-control'])}}
                                {{-- <input type="text" class="form-control" id="owner"> --}}
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::textarea('curriculum','',['class'=>'form-control','rows'=>'3'])}}
                                {{-- <textarea class="form-control" rows="3" id="comment"></textarea> --}}
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('time_start','',['class'=>'form-control'])}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('time_end','',['class'=>'form-control'])}}
                    ...
                    <div class="col-sm textcenter" style="margin:auto">
                        <div class="form-group row m-0" >
                            <div class="col-sm-12" style="text-align: center;">
                                ...
                                {{Form::submit('Add Daycare',['class'=>'btn btn-primary btn-lg'])}}
                            </div>
                        </div>
                    </div>
                </div>
...
@section('inline_js')
    <script>
        function show_daycare_activity(activity_no){
            ...
            document.getElementById('add_daycare_form').style.display="none";
            document.getElementById('search_update_daycare_div').style.display="none";
            document.getElementById('search_delete_daycare_div').style.display="none";
