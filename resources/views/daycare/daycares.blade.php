                ...
                <div class="row">
                    <div class="col-lg-2 text-center mt-4" style="margin:auto;">
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="#" onclick="getElementById('age').innerHTML = 'Age : ' + getElementById('a1').innerHTML; search_database();" id="a1">1</a>
                            <a class="dropdown-item" href="#" onclick="getElementById('age').innerHTML = 'Age : ' + getElementById('a2').innerHTML" id="a2">2</a>
                            <a class="dropdown-item" href="#" onclick="getElementById('age').innerHTML = 'Age : ' + getElementById('a3').innerHTML" id="a3">5</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 text-center mt-4" style="margin:auto;">
                                    ...
                                    <div class="col-lg-6 bg-white" style="display: flex;align-items: center;justify-content: center;">
                                        <div >
                                            <ul class="list-group list-group-flush" >
                                                ...
                                                <li class="list-group-item py-1"><b>Address : </b>{{$daycare->address}}</li>
